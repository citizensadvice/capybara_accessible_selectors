...
module Capybara
  module RSpecMatchers
    %i[alert article banner columnheader combo_box contentinfo dialog grid gridcell img main
       menu menuitem modal navigation region row tab_panel tab_button disclosure
