...
RSpec.describe Capybara::Node::Element, "#accessible_description", driver: :rack_test do
  describe "aria-describedby" do
    it "returns an accessible name from aria-describedby" do
      render <<~HTML
        <div role="group" aria-describedby="id2 id1" data-test-id="test" aria-label="label" title="title">Contents</div>
